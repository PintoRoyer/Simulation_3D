...
wind_w = files.data_vars["WT"][0, z_start: z_end, x_start, y_start: y_end] * 3.6
wind_v = files.data_vars["VT"][0, z_start: z_end, x_start, y_start: y_end] * 3.6
...
c = plt.contour(nj, ALT, clouds, levels=(0.1, ))
cf = plt.contourf(nj, ALT, wind_norm_vw, levels=np.linspace(wind_norm_vw.min(), wind_norm_vw.max(), 100), cmap="seismic")
